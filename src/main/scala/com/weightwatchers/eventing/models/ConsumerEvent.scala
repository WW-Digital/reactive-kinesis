...
package com.weightwatchers.eventing.models
...
/**
  * The actual event we're processing (contained within [[com.weightwatchers.eventing.consumer.ConsumerWorker.ProcessEvent]]
  */
