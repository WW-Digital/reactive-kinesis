...
import com.weightwatchers.eventing.SimpleKinesisConsumer._
...
import com.weightwatchers.eventing.models.CompoundSequenceNumber
import kamon.Kamon
...
/**
  ...
  *
  * aws kinesis delete-stream --stream-name core-test-kinesis-reliability && \
  * aws dynamodb delete-table --table-name CoreKinesisReliabilitySpec && \
  * sleep 120 && \
  * aws kinesis create-stream --stream-name core-test-kinesis-reliability --shard-count 2
  */
